...
import { useState } from "react";
import '../Iteration/Trial/FIBD.css';

export default function PTEFillInTheBlanks({ questionData, onBack }) {
  const { textParts, blanksCount, options, title } = questionData;

  // State to store answers for each blank
  const [answers, setAnswers] = useState(Array(blanksCount).fill(""));
  ...
  return (
    <div className="pte-page">
      <div className="pte-container">
        ...
        <p className="pte-subtitle">
          Drag the correct word from the bottom and drop it into the blanks.
        </p>
