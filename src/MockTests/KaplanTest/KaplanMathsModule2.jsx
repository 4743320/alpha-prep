...
import questions from "../../Data/KaplanTest/math_module2.json";
...
const KaplanMathsModule2 = () => {
  ...
  const handleSubmit = () => {
    ...
    saveLocalScores("Kaplan-Math Module 2", calculatedScore);
    console.log("Math Module 2 Score:", calculatedScore);

    // 🚀 After submit → go to result card
    navigate("/result-page",{state:{testName: "Kaplan"}});
  };
      ...
      <div className="question-box">
        ...
        <div className="question-text">
         {currentQuestion.image && <div className="image-container">
           <img src={currentQuestion.image} alt="{`Question ${currentIndex+1} visual}"
        ...
        <div className="options-list">
          {Object.entries(currentQuestion.options).map(([letter, text]) => (
            // <label key={letter} className={`option-button ${getOptionClass(letter)}`}>
            //   <input
            //     type="radio"
  ...
  const renderStudentResponse = () => (
    <div className="sat-container">
      <div className="sat-header">
        <h2>Kaplan Math Module 2: Student-Produced Response</h2>
...
export default KaplanMathsModule2;
