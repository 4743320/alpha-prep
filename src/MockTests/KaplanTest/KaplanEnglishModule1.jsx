...
import questions from "../../Data/KaplanTest/EnglishMod1.json";

const KaplanEnglishModule1 = () => {
  ...
  const handleSubmit = () => {
    ...
    saveLocalScores("Kaplan-English Module 1", calculatedScore);
    navigate('/kap-e-m2');
  };
...
export default KaplanEnglishModule1;
