// src/pages/SAT/PrincetonEngModule2.jsx
import React, { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { useSatScore } from "../../hooks/UseSatScore";
import "../../styles/satenglish.css";
import questions from "../../Data/PrincetonTest/Eng_module2.json";

const PrincetonEnglishModule2 = () => {
  ...
  const handleSubmit = () => {
    ...
    saveLocalScores("Princeton-English Module 2", calculatedScore);
    navigate('/kap-e-m2');
  };
  ...
  return (
    <div className="test-container">
      ...
      {/* ===== Main Test Section ===== */}
      <div className="scrollable-test-main">
...
export default PrincetonEnglishModule2;
