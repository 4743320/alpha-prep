...
import questions from '../../Data/PrincetonTest/Math_module2.json';
import { useNavigate } from "react-router-dom";
import { useSatScore } from "../../hooks/UseSatScore";
import '../../styles/satmath.css';


const PrincetonMathsModule2 = () => {
  ...
  const handleSubmit = () => {
    ...
    saveLocalScores("Princeton-Math Module 2", calculatedScore);
...
<label key={letter} className="option-button">
  ...
  const renderStudentResponse = () => (
    <div className="sat-container">
      <div className="sat-header">
        <h2>Princeton Math Module 2: Student-Produced Response</h2>
...
export default PrincetonMathsModule2;
