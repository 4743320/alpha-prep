// src/pages/SAT/PrincetonEngModule1.jsx
import React, { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { useSatScore } from "../../hooks/UseSatScore";
import "../../styles/satenglish.css";
import questions from "../../Data/PrincetonTest/Eng_module1.json";

const PrincetonEnglishModule1 = () => {
  ...
  const handleSubmit = () => {
    ...
    saveLocalScores("Princeton-English Module 1", calculatedScore);
    navigate('/kap-e-m2');
  };
...
export default PrincetonEnglishModule1;
