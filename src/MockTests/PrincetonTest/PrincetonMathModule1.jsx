...
import questions from '../../Data/PrincetonTest/Math_module1.json';
import { useNavigate } from "react-router-dom";
import { useSatScore } from "../../hooks/UseSatScore";
import '../../styles/satmath.css';

const PrincetonMathsModule1 = () => {
  ...
  const handleSubmit = () => {
    ...
    saveLocalScores("Princeton-Math Module 1", calculatedScore);
...
<label key={letter} className="option-button">
  ...
  const renderStudentResponse = () => (
    <div className="sat-container">
      <div className="sat-header">
        <h2>Princeton Math Module 1: Student-Produced Response</h2>
...
export default PrincetonMathsModule1;
