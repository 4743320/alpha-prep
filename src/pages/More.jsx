...
function Hero() {
  return (
    <section className="hero">
      <div className="hero-text">
        <h1>Improve your Skills in a Modern Way</h1>
        <p>Access top courses and learn from expert mentors anywhere, anytime.</p>
        <div className="hero-buttons">
      ...
      <div className="hero-image">
        <img src="https://i.ibb.co/3vC0dL3/hero-image.png" alt="Hero" />
      </div>
    </section>
  );
}
...
function Courses() {
  const courseList = [
    { title: 'Web Development', price: '$50', img: 'https://i.ibb.co/jrHkK5F/course-web.png' },
    { title: 'Data Science', price: '$60', img: 'https://i.ibb.co/D5f1qFP/course-data.png' },
    { title: 'UI/UX Design', price: '$40', img: 'https://i.ibb.co/KV7VqWZ/course-uiux.png' },
  ];
...
// ---------------- Features ----------------
function Features() {
  const features = ['Easy Access', 'Affordable', 'Flexible Study Time', 'Certification Provided'];
  return (
    <section className="features">
      <h2>Why Choose Coursespace</h2>
      <div className="feature-grid">
...
function Mentors() {
  const mentors = [
    { name: 'John Doe', skill: 'Web Development', img: 'https://i.ibb.co/ZV1k6tM/mentor1.png' },
    { name: 'Jane Smith', skill: 'Data Science', img: 'https://i.ibb.co/9sN8xW6/mentor2.png' },
  ];
  return (
    <section className="mentors">
      <h2>Meet Our Mentors</h2>
